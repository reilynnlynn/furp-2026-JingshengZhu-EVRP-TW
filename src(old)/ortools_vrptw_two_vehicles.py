...
def create_toy_instance(n_customers, seed=42):
    ...
    if n_customers == 20:
        cluster_a = [
            (10, 15), (14, 25), (18, 35), (22, 18), (25, 30),
            (30, 22), (16, 45), (28, 40), (20, 10), (35, 35)
        ]
        cluster_b = [
            (70, 70), (75, 82), (82, 68), (88, 78), (92, 62),
            (68, 88), (80, 92), (95, 85), (72, 58), (86, 55)
        ]
    ...
    horizon = 400 if n_customers == 20 else (1000 if n_customers <= 50 else 1500)
    ...
    if n_customers == 20:
        for i in range(1, 11):
            time_windows.append((0, 120))
        for i in range(11, 21):
            time_windows.append((140, 280))
    else:
...
def print_markdown_table(rows):
    ...
    print("|---|---|---|---|---|---|---|")
    for row in rows:
        runtime_val = row["runtime_sec"] if row["runtime_sec"] is not None else 0.0
        print(
            f"| {row['instance_size']} | {row['strategy']} | {row['use_time_windows']} | "
            f"{row['feasible']} | {row['objective']} | {runtime_val:.4f} | {row['vehicles_used']} |"
        )
